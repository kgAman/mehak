<x-admin-layout>
    <div class="bg-[#020617] min-h-screen py-10 relative">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <!-- The Form -->
<form action="{{ route('admin.portfolio-admin.store') }}" method="POST" enctype="multipart/form-data" class="bg-slate-900 border border-slate-700 shadow-2xl rounded-sm p-8 md:p-10 relative overflow-hidden">                <!-- Decorative top border -->
                ...
                <div class="mt-8 border-t border-slate-800 pt-6 flex justify-end gap-4">
                    <a href="#" class="px-6 py-3 text-sm font-bold text-gray-400 uppercase tracking-widest hover:text-white transition-colors">Cancel</a>
