...
<head>
    ...
    <title>Forgot Password - Property Maintenance</title>
        ...
        <div class="w-full max-w-md pointer-events-auto mb-10">
            ...
            <div class="text-center mb-8 drop-shadow-lg">
                <div class="inline-flex items-center justify-center w-16 h-16 bg-amber-500 mb-4 shadow-[0_0_30px_rgba(245,158,11,0.5)] rounded-sm">
                    <i data-lucide="shield-alert" class="w-8 h-8 text-slate-900 stroke-[2]"></i>
                </div>
                <h2 class="text-3xl font-black uppercase tracking-widest text-white">Password <span class="text-amber-500">Recovery</span></h2>
            </div>
            ...
            <div class="bg-slate-900/60 backdrop-blur-xl border border-slate-700/50 p-8 sm:p-10 rounded-sm shadow-[0_8px_32px_rgba(0,0,0,0.8)] relative overflow-hidden">
                ...
                <div class="mb-6 text-sm text-gray-400 leading-relaxed font-medium">
                    {{ __('Forgot your password? No problem. Just let us know your email address and we will email you a password reset link that will allow you to choose a new one.') }}
                </div>

                <x-auth-session-status class="mb-4 text-amber-500 font-bold text-sm" :status="session('status')" />
            ...
            <div class="text-center mt-6">
                <a href="{{ route('login') }}" class="text-xs font-bold text-gray-500 uppercase tracking-widest hover:text-white transition-colors flex items-center justify-center gap-2">
