...
<head>
    ...
    <title>Register - Property Maintenance</title>
...
<body class="font-['Montserrat',_sans-serif] bg-slate-950 text-white overflow-hidden h-screen w-screen selection:bg-amber-500 selection:text-slate-900 flex flex-col">
    ...
    <div class="relative z-10 flex-grow flex items-center justify-center w-full px-4 sm:px-6 lg:px-8 py-10 overflow-y-auto pointer-events-none" style="scrollbar-width: none;">
        
        <div class="w-full max-w-md pointer-events-auto my-auto">
            ...
            <div class="text-center mb-8 drop-shadow-lg">
                <div class="inline-flex items-center justify-center w-16 h-16 bg-amber-500 mb-4 shadow-[0_0_30px_rgba(245,158,11,0.5)] rounded-sm">
                    <i data-lucide="user-plus" class="w-8 h-8 text-slate-900 stroke-[2]"></i>
                </div>
                <h2 class="text-3xl font-black uppercase tracking-widest text-white">Create <span class="text-amber-500">Account</span></h2>
                <p class="text-gray-400 text-sm mt-2 font-medium tracking-wide">Register for portal access</p>
            </div>
            ...
            <div class="bg-slate-900/60 backdrop-blur-xl border border-slate-700/50 p-8 sm:p-10 rounded-sm shadow-[0_8px_32px_rgba(0,0,0,0.8)] relative overflow-hidden">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    <div>
                        <label for="name" class="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-2 flex items-center gap-2">
                            <i data-lucide="user" class="w-4 h-4"></i> Full Name
                        </label>
                    ...
                    <div>
                        <label for="password_confirmation" class="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-2 flex items-center gap-2">
                    ...
                    <div class="flex items-center justify-end pt-2">
                        <a class="text-xs font-bold text-amber-500 uppercase tracking-wider hover:text-white transition-colors underline decoration-amber-500/30 underline-offset-4" href="{{ route('login') }}">
                    ...
                    <button type="submit" class="w-full inline-flex justify-center items-center gap-3 rounded-sm bg-amber-500 px-8 py-3.5 text-sm font-black text-slate-900 shadow-[4px_4px_0px_0px_#475569] hover:shadow-[2px_2px_0px_0px_#475569] hover:translate-x-[2px] hover:translate-y-[2px] transition-all duration-200 uppercase tracking-widest mt-6">
                        Register Account <i data-lucide="arrow-right" class="w-4 h-4"></i>
                    </button>
                </form>
            </div>
